...
def main():
    ...
    while True:
        ...
        num_sents = input("Enter the number of sentences for the summary: ")
...
def remove_stop_words(speech_edit):
    '''removes stop words from string and return string'''
...
def get_word_freq(speech_edit_no_stop):
    '''return dictionary of word frequency in a string'''
